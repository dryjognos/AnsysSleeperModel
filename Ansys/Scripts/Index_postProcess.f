...
/CLEAR
/GO
!Not working, this needs to load already finished models and post process their results. 
!/TODO use the RESUME-command to load models / databases.
...
G_index_file(1) = 'Index_postProcess' !Set to current filename to track back the parameters file to this index file.
WorkingDirectoryName(1) = 'PostProcessingResults' !Directory name for results
