...
G_index_file(1) = 'Index_badFoundations.f' !Set to current filename to track back the parameters file to this index file.
WorkingDirectoryName(1) = 'BadFoundations' !Directory name for results
...
! ----------------------------------------------------------
! ------------- Analysis specific parameters: --------------
WorkingDirectoryNameAddition(1) = 'Multiple' !Directory name addition to general folder:
