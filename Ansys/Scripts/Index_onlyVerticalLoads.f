...
G_index_file(1) = 'Index_onlyVerticalLoads.f' !Set to current filename to track back the parameters file to this index file.
WorkingDirectoryName(1) = 'Results_OnlyVertical' !Directory name for results
